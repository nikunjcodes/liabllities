...
<div class="max-w-2xl mx-auto p-5">
    ...
    <div class="mb-10 w-full">
        ...
        <div class="flex items-center justify-between">
            ...
            <div>
                ...
                <form action="{{ route('delete-post', $post) }}" method="post" onsubmit="return confirm('Are you sure to delete this post?')">
                    ...
                    <button class="block px-4 py-2 text-sm text-gray-700 hover:text-red-500 transition">Edit this post</button>
        ...
        <div>
            @can('delete', $post)
                <form action="{{ route('edit-post', $post) }}" method="post" onsubmit="return confirm('Are you sure to Edit this post?')">
                    @csrf
                    @method("EDIT")
                    <button class="block px-4 py-2 text-sm text-gray-700 hover:text-red-500 transition">Edit this post</button>
                </form>
